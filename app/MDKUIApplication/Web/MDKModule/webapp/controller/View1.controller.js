sap.ui.define([
	...
	return Controller.extend("e2ebjtest0220_MDKUIApplication.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("e2ebjtest0220_MDKUIApplication/mdkindex.html?" + queryString);
